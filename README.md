...
Uses the CDC-ECM (Ethernet Control Model) USB class protocol — no vendor-specific drivers needed. Works in both **Arduino IDE** and **ESP-IDF**. If it works with a Nintendo Switch it will work here.
